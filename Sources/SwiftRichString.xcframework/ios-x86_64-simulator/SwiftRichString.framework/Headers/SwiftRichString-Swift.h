...
#ifndef SWIFTRICHSTRING_SWIFT_H
#define SWIFTRICHSTRING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftRichString",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15SwiftRichString19AsyncTextAttachment")
@interface AsyncTextAttachment : NSTextAttachment
...
SWIFT_PROTOCOL("_TtP15SwiftRichString27AsyncTextAttachmentDelegate_")
@protocol AsyncTextAttachmentDelegate
/// Called when the image has been loaded
- (void)textAttachmentDidLoadImageWithTextAttachment:(AsyncTextAttachment * _Nonnull)textAttachment displaySizeChanged:(BOOL)displaySizeChanged;
@end
...
@interface UILabel (SWIFT_EXTENSION(SwiftRichString))
/// The name of a style in the global <code>NamedStyles</code> registry.
@property (nonatomic, copy) IBInspectable NSString * _Nullable styleName;
@end


@interface UITextField (SWIFT_EXTENSION(SwiftRichString))
/// The name of a style in the global <code>NamedStyles</code> registry.
@property (nonatomic, copy) IBInspectable NSString * _Nullable styleName;
@end


@interface UITextView (SWIFT_EXTENSION(SwiftRichString))
/// The name of a style in the global <code>NamedStyles</code> registry.
@property (nonatomic, copy) IBInspectable NSString * _Nullable styleName;
@end
...
SWIFT_CLASS("_TtC15SwiftRichString16XMLStringBuilder")
@interface XMLStringBuilder : NSObject <NSXMLParserDelegate>
