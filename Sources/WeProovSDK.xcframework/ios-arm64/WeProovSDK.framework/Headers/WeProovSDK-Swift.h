...
#ifndef WEPROOVSDK_SWIFT_H
#define WEPROOVSDK_SWIFT_H
...
SWIFT_PROTOCOL("_TtP10WeProovSDK23CameraInferenceDelegate_")
@protocol CameraInferenceDelegate
- (BOOL)isACarWithCgimage:(CGImageRef _Nonnull)cgimage SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, SignatureLinkAction, open) {
  SignatureLinkActionActionPdf = 0,
  SignatureLinkActionActionWebView = 1,
};
...
@interface WPCamera (SWIFT_EXTENSION(WeProovSDK)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)cameraFailedCaptureImage:(NSError * _Nonnull)error;
- (void)cameraDidRecognizeQrCode:(NSString * _Nonnull)metadata;
- (void)cameraDidRecognizeVIN:(NSString * _Nonnull)metadata;
- (void)cameraDidRecognizePlate:(NSString * _Nonnull)metadata;
@end
...
SWIFT_CLASS("_TtC10WeProovSDK29WPInformationIAViewController")
@interface WPInformationIAViewController : WPVC
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)loadView;
...
- (CLAuthorizationStatus)getStatusLocationManager SWIFT_WARN_UNUSED_RESULT;
- (void)stopUpdateLocation;
- (void)resetLocation;
- (void)locationManager:(CLLocationManager * _Nonnull)_ didChangeAuthorizationStatus:(CLAuthorizationStatus)didChangeAuthorization;
- (void)locationManager:(CLLocationManager * _Nonnull)_ didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
@end

@class WPPartOption;
@class WPSignatureOptions;

SWIFT_CLASS("_TtC10WeProovSDK12WPParameters")
@interface WPParameters : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) WPParameters * _Nullable shared;)
+ (WPParameters * _Nullable)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(WPParameters * _Nullable)value;
@property (nonatomic, copy) NSDictionary<NSNumber *, WPPartOption *> * _Nonnull partOptions;
@property (nonatomic) BOOL isImportSectionVisibleByDefault;
@property (nonatomic) BOOL canSave;
@property (nonatomic) BOOL keepCache;
@property (nonatomic) BOOL canUploadInBackground;
@property (nonatomic) BOOL enableDamageList;
@property (nonatomic, strong) WPSignatureOptions * _Nullable signatureOptions;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10WeProovSDK12WPPartOption")
@interface WPPartOption : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
typedef SWIFT_ENUM(NSInteger, ReportState, open) {
  ReportStatePendingFirst = 0,
  ReportStatePendingSecond = 1,
  ReportStateFinished = 2,
};

typedef SWIFT_ENUM(NSInteger, WPReportCloseState, open) {
  WPReportCloseStateCanceled = 0,
  WPReportCloseStateSaved = 1,
  WPReportCloseStateBackground = 2,
  WPReportCloseStateSubmitted = 3,
};
...
- (void)loadWithTemplateId:(NSInteger)templateId dataToFillTemplate:(NSString * _Nullable)dataToFillTemplate item:(ItemsStruct * _Nullable)item;
...
- (BOOL)reportCanShowSectionImportWithDownloader:(WPReportDownloader * _Nonnull)downloader section:(NSInteger)section SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Deprecated. Please do not use it anymore.");
@end
...
SWIFT_PROTOCOL("_TtP10WeProovSDK36WPReportUploadViewControllerDelegate_")
@protocol WPReportUploadViewControllerDelegate
/// Tell the delegate the user touch the retry button
- (void)callRetry;
/// Tell the delegate the user touch the background button
- (void)setUploadToBackground;
@end
...
- (void)reportUploaderUploadFinishedWithIdentifier:(NSString * _Nonnull)identifier withView:(BOOL)withView error:(BOOL)error;
@end


@interface WPReportManager (SWIFT_EXTENSION(WeProovSDK)) <WPReportUploadViewControllerDelegate, WPReportUploaderDelegate>
- (void)reportUploaderUploadAddedWithIdentifier:(NSString * _Nonnull)identifier;
- (void)reportUploaderUploadUpdatedWithIdentifier:(NSString * _Nonnull)identifier progress:(float)progress;
- (void)reportUploaderUploadFinishedWithIdentifier:(NSString * _Nonnull)identifier withView:(BOOL)withView error:(BOOL)error;
- (void)setUploadToBackground;
...
@protocol WPReportSaveViewControllerDelegate;

SWIFT_CLASS("_TtC10WeProovSDK26WPReportSaveViewController")
@interface WPReportSaveViewController : WPVC
@property (nonatomic, weak) id <WPReportSaveViewControllerDelegate> _Nullable delegate;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)loadView;
@end
...
SWIFT_PROTOCOL("_TtP10WeProovSDK34WPReportSaveViewControllerDelegate_")
@protocol WPReportSaveViewControllerDelegate
/// Tell the delegate the user touch the cancel button
- (void)reportCancelSave;
@end

@protocol WPReportSaverDelegate;

SWIFT_CLASS("_TtC10WeProovSDK13WPReportSaver")
@interface WPReportSaver : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) WPReportSaver * _Nonnull shared;)
+ (WPReportSaver * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, weak) id <WPReportSaverDelegate> _Nullable delegate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_PROTOCOL("_TtP10WeProovSDK21WPReportSaverDelegate_")
@protocol WPReportSaverDelegate
- (void)reportSaverUploadAddedWithIdentifier:(NSString * _Nonnull)identifier;
/// progress of the upload, value between 0.0 and 1.0
- (void)reportSaverUploadUpdatedWithIdentifier:(NSString * _Nonnull)identifier progress:(float)progress;
- (void)reportSaverUploadFinishedWithIdentifier:(NSString * _Nonnull)identifier withView:(BOOL)withView error:(BOOL)error;
@end


SWIFT_CLASS("_TtC10WeProovSDK28WPReportUploadViewController")
@interface WPReportUploadViewController : WPVC
@property (nonatomic, weak) id <WPReportUploadViewControllerDelegate> _Nullable delegate;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)loadView;
- (void)viewWillDisappear:(BOOL)animated;
...
SWIFT_CLASS("_TtC10WeProovSDK21WPSignatureLinkOption")
@interface WPSignatureLinkOption : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10WeProovSDK18WPSignatureOptions")
@interface WPSignatureOptions : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10WeProovSDK17WPTableLoaderView")
@interface WPTableLoaderView : UIView
...
SWIFT_CLASS("_TtC10WeProovSDK25WPTagInfoIAViewController")
@interface WPTagInfoIAViewController : WPVC
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)loadView;
- (void)viewWillDisappear:(BOOL)animated;
...
@property (nonatomic, strong) UIColor * _Nonnull signatureNavigationBarItemsColor;
...
@property (nonatomic, strong) UIColor * _Nonnull signatureSubmitButtonBackgroundColor;
@property (nonatomic, strong) UIColor * _Nonnull signatureSubmitButtonColor;
@property (nonatomic, strong) UIFont * _Nonnull signatureSubmitButtonFont;
@property (nonatomic, strong) UIColor * _Nonnull signatureClearButtonColor;
@property (nonatomic, strong) UIFont * _Nonnull signatureClearButtonFont;
@property (nonatomic, strong) UIColor * _Nonnull signatureSeeReportButtonColor;
@property (nonatomic, strong) UIFont * _Nonnull signatureSeeReportButtonFont;
...
@property (nonatomic, strong) UIColor * _Nonnull signatureFooterHighlightColor;
...
@property (nonatomic, strong) UIColor * _Nonnull cameraAnnotationEditorHeaderButtonTextColor;
...
@property (nonatomic, strong) UIFont * _Nonnull cameraAnnotationEditorHeaderMatrixTextFont;
...
@property (nonatomic, strong) UIColor * _Nonnull cameraAskIfThereDamageBackgroundColor;
@property (nonatomic, strong) UIColor * _Nonnull cameraAskIfThereDamageTextColor;
@property (nonatomic, strong) UIFont * _Nonnull cameraDamageEditorContentFont;
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setAppAuthCredentialsWithClientID:(NSString * _Nonnull)clientID secret:(NSString * _Nonnull)secret;
- (void)connect;
- (void)logout;
...
/// Internal usage
- (void)onUserSuccess:(UserStruct * _Nullable)_;
/// Internal usage
- (void)onUserNeedMultipleAuthentication:(NSInteger)processID webviewURL:(NSString * _Nullable)webviewURL;
@end
...
/// Tells the delegate when the user need multiple authentication
- (void)userNeedMultipleAuthenticationWithUser:(WPUser * _Nonnull)user :(NSInteger)processId webViewUrl:(NSString * _Nullable)url;
@end



SWIFT_CLASS("_TtC10WeProovSDK8WpErrors")
@interface WpErrors : NSError
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)_ OBJC_DESIGNATED_INITIALIZER;
